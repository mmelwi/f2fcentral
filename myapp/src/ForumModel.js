...
class ForumModel {
    ...
    getAccordionTitle()
    {
        return (<div style={{display: "flex", justifyContent: "flex-start"}}>
            <h5 align="left" style={{flexGrow: 2, fontSize: 12, fontStyle: 'italic'}}>{this.getIconForFeedbackType()}&nbsp; {this.title}</h5>
            <FaWechat Icon align="left" size={35} color={'#63C050'} style={{flexGrow: "1"}}/>
        </div>);
    }
